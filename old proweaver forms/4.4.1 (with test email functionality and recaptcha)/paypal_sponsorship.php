    ...
    <?php endif; ?>
       ...
       <?php endif; ?>
        ...
        function getajax(){
          ...
          $.ajax({
            type: "POST",
            url: "<?php (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>ajax-payment.php?form_name=<?= $form ?>",
            data: formdata,
        ...
        paypal.Button.render({
            ...
            payment: function(data, actions) {
              // return actions;
                ...
                var CREATE_URL = "<?php (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>ajax-payment.php?paypal=direct&form_name=<?= $form ?>";
            ...
            onAuthorize: function(data, actions) {
                ...
                var EXECUTE_URL = "<?php (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>ajax-payment.php?paypal=return&form_name=<?= $form ?>";
